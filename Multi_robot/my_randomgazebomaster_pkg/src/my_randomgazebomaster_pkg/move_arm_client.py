...
class MoveArmClient(object):
    ...
    def __init__(self):
        rospy.logwarn("Waiting for service /arm_move_service")
        rospy.wait_for_service('/arm_move_service')
        self.arm_move_service = rospy.ServiceProxy('/arm_move_service', ArmMove)
