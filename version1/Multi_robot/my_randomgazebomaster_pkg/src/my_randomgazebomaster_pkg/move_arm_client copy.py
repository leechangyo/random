...
class MoveArmClient(object):
    ...
    def __init__(self):
        rospy.logwarn("Waiting for service /robot1/arm_controller/query_state")
        rospy.wait_for_service('/robot1/arm_controller/follow_joint_trajectory')
        self.arm_move_service = rospy.ServiceProxy('/robot1/arm_controller/follow_joint_trajectory', ArmMove)
        self.arm_move_request = ArmMoveRequest()
    ...
    def move_endeffector(self, position_XYZ, orientation_XYZW):
        ...
        self.arm_move_request.joints_array = [0.0] * 7
        
        self.arm_move_request.movement_type.data = "TCP"
    ...
    def move_joints(self, joints_config):
        ...
        self.arm_move_request.joints_array = joints_config
        
        self.arm_move_request.movement_type.data = "JOINTS"
